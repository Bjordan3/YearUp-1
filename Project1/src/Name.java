...
// scanner that scans the next input
...
// declares a data type double and makes it zero
		double userHeight = 0;
//Prints saves the input of name in a string and the height and age in an int variable
...
// calls the methods of Add with parameters and Add without parameters and displays them
		Add();
		Add(10, 20);
// states a data type to store the values of the areas from the circle and rectangle methods 
...
// prints the stored values of the areas of the circle and rectangle
		System.out.println("The area of the circle is "
				+ AreaInMainMethodC + ", and the area of the rectangle is "
				+ AreaInMaindMethodR + ".");
...
// stores the next amount in the amt variable
		amt = s.nextFloat();
// calls all the methods to have the amt stored from the input into them and be executed
		double tenPercent = TenPercent(amt);
		double fifteenPercent = FifteenPercent(amt);
		double twentyPercent = TwentyPercent(amt);
// Prints out the bill amounts with the 10 15 and 20 percent amounts added on
		System.out.println("You tips are as follow. 10%: " + tenPercent
